...
!function(jQuery, undefined) {
    ...
    jQuery.fn.extend({
        ...
        revstart: function() {
            var a = jQuery(this);
            if (a != undefined && a.length > 0 && jQuery("body").find("#" + a.attr("id")).length > 0 && this.opt)
    ...
    var _ISM = _R.is_mobile()
      ...
      , getNeededScripts = function(a, b) {
        ...
        ("off" !== a.parallax.type || a.viewPort.enable || "true" == a.viewPort.enable) && (c.parallax = !0)) : (c.kenburns = !0,
        c.parallax = !0,
        c.carousel = !1,
        c.navigation = !0,
        c.videos = !0,
      ...
      , runSlider = function(a, b) {
        ...
        !a.hasClass("revslider-initialised")) {
            ...
            a.find(".tp-caption, .rs-background-video-layer").each(function(a) {
                ...
                c.hasClass("tp-caption")) {
                    var k = c.hasClass("slidelink") ? "width:100% !important;height:100% !important;" : ""
                      ...
                      , o = "";
                    "row" === m ? (c.addClass("rev_row").removeClass("tp-resizeme"),
                    o = "rev_row_wrap") : "column" === m ? (o = "rev_column",
                    ...
                    var q = ""
                      , r = "";
                    "row" !== m && "group" !== m && "column" !== m && (q = "display:" + c.css("display") + ";",
                    c.closest(".rev_column").length > 0 && c.addClass("rev_layer_in_column"),
                    c.closest(".rev_group").length > 0 && c.addClass("rev_layer_in_group")),
                    l.wrapper_class !== undefined && (o = o + " " + l.wrapper_class),
                    l.wrapper_id !== undefined && (r = 'id="' + l.wrapper_id + '"'),
                    c.wrap('<div class="tp-parallax-wrap ' + o + '" style="' + k + "position:" + n + ";" + q + ';visibility:hidden"><div class="tp-loop-wrap" style="' + k + "position:" + n + ";" + q + ';"><div class="tp-mask-wrap" style="' + k + "position:" + n + ";" + q + ';" ></div></div></div>'),
                    "column" === m && (c.append('<div class="rev_column_bg rev_column_bg_man_sized" style="display:none"></div>'),
            ...
            prepareSlides(a, b),
            "off" !== b.parallax.type && _R.checkForParallax && _R.checkForParallax(a, b),
            _R.setSize(b),
            ...
            setTimeout(function() {
                if ("carousel" == b.sliderType && _R.prepareCarousel && _R.prepareCarousel(b),
                !s.enable || s.enable && b.inviewport || s.enable && !b.inviewport && "wait" == !s.outof)
                    swapSlide(a);
                else if (b.waitForFirstSlide = !0,
                s.presize) {
                    var c = jQuery(b.li[0]);
                    loadImages(c, b, 0, !0),
      ...
      , prepareSlides = function(a, b) {
        ...
        b.allli.find(">img").each(function(a) {
            ...
            c.wrap('<div class="slotholder ' + f + '" style="position:absolute; top:0px; left:0px; z-index:0;width:100%;height:100%;"></div>'),
      ...
      , swapSlide = function(a) {
        ...
        var c = a.find(".active-revslide")
          ...
          , e = d.find(".defaultimg");
        return d.index() === c.index() ? (d.removeClass("next-revslide"),
        !1) : (d.removeClass("next-revslide").addClass("processing-revslide"),
