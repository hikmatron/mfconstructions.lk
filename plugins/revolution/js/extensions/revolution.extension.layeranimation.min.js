...
!function(a) {
    ...
    jQuery.extend(!0, b, {
        ...
        animcompleted: function(a, c) {
            ...
            void 0 != e && "none" != e && (1 == f || "true" == f || "on" == f || "1sttime" == f || g ? (b.playVideo(a, c),
        ...
        handleStaticLayers: function(a, b) {
            ...
            c < 0 && (c = 0),
            d < 0 && (d = b.slideamount),
            0 === c && d === b.slideamount - 1 && (d = b.slideamount + 1),
            a.data("startslide", c),
            a.data("endslide", d)
        },
        animateTheCaptions: function(a) {
            ...
            c.layers[l] && jQuery.each(c.layers[l], function(a, d) {
            ...
            h || void 0 !== i && (jQuery.each(c.timelines[l].layers, function(a, d) {
                var e = d.layer.data();
            ...
            c.timelines.staticlayers && jQuery.each(c.timelines.staticlayers.layers, function(a, d) {
                ...
                e.triggeredtimeline.time(j)) : d.timeline.time(j)),
                "reset" === p && "hidden" === o && (d.timeline.time(0),
                e.animdirection = "out"),
                f ? k ? n === d.lastslide && (d.timeline.play(i),
                e.animdirection = "in") : (l || "out" === e.animdirection || d.timeline.play(h),
        ...
        prepareSingleCaption: function(a) {
            ...
            d._slidelink = d._slidelink || c.hasClass("slidelink"),
            void 0 === d._li && (c.hasClass("tp-static-layer") ? (d._li = c.closest(".tp-static-layers"),
            ...
            void 0 === d._togglelisteners && c.find(".rs-toggled-content") ? d._togglelisteners = !0 : d._togglelisteners = !1,
            ...
            !k.generated || a.regenerate === !0) {
                ...
                d.hoverframeindex !== -1 && void 0 !== d.hoverframeindex && !c.hasClass("rs-hover-ready")) {
                    ...
                    i.svg) {
                        ...
                        void 0 != n.anim.color && (p.anim.fill = n.anim.color),
                        d.hoversvg = p
                    }
                    c.hover(function(a) {
                        var b = {
                        ...
                        i.svg && (g.hovertimelines.svghoveranim = punchgs.TweenLite.to(i.svg, h.speed / 1e3, g.hoversvg.anim)),
                        g.hoveredstatus = !0)
                    }, function(a) {
                        var b = {
                            caption: jQuery(a.currentTarget),
                        ...
                        i.svg && punchgs.TweenLite.to(i.svg, h.speed / 1e3, g.idlesvg.anim))
                    })
                }
        ...
        createFrameOnTimeline: function(a) {
            ...
            void 0 !== z && z !== !1 && (z.anim.ease = void 0 === z.anim.ease || "inherit" === z.anim.ease ? d.frames[0].ease : z.anim.ease,
            ...
            0 === h && y && y !== !1 && !a.fromcurrentstate ? (z = new Object,
            z.anim = new Object,
            z.anim.overwrite = "auto",
            z.anim.ease = t.anim.ease,
            z.anim.x = z.anim.y = 0,
            y.anim.x = y.anim.x * j.bw || l(y.anim.x, j, d.eow, d.eoh, d.calcy, d.calcx, "horizontal"),
            ...
            o.content.eventCallback("onComplete", function(a, d, e, f, g, h, i) {
                ...
                "leftstage" === k.eventtype && (punchgs.TweenLite.set(f, {
                    visibility: "hidden"
                }),
                g.animdirection = "out",
                g.visibleelement = !1,
      ...
      , m = function(a, b, c) {
        ...
        return e && jQuery.each(e, function(a, b) {
            var e = b.split(":")
              , f = e[0]
              , g = e[1];
            c && void 0 != g && g.length > 0 && g.match(/\(R\)/) && (g = g.replace("(R)", ""),
            g = "right" === g ? "left" : "left" === g ? "right" : "top" === g ? "bottom" : "bottom" === g ? "top" : g,
            "[" === g[0] && "-" === g[1] ? g = g.replace("[-", "[") : "[" === g[0] && "-" !== g[1] ? g = g.replace("[", "[-") : "-" === g[0] ? g = g.replace("-", "") : g[0].match(/[1-9]/) && (g = "-" + g)),
            void 0 != g && (g = g.replace(/\(R\)/, ""),
            "rotationX" != f && "rX" != f || (d.anim.rotationX = k(g, d.anim.rotationX) + "deg"),
            "rotationY" != f && "rY" != f || (d.anim.rotationY = k(g, d.anim.rotationY) + "deg"),
            "rotationZ" != f && "rZ" != f || (d.anim.rotation = k(g, d.anim.rotationZ) + "deg"),
            "scaleX" != f && "sX" != f || (d.anim.scaleX = k(g, d.anim.scaleX)),
            "scaleY" != f && "sY" != f || (d.anim.scaleY = k(g, d.anim.scaleY)),
            "opacity" != f && "o" != f || (d.anim.opacity = k(g, d.anim.opacity)),
            0 === d.anim.opacity && (d.anim.autoAlpha = 0),
            d.anim.opacity = 0 == d.anim.opacity ? 1e-4 : d.anim.opacity,
            "skewX" != f && "skX" != f || (d.anim.skewX = k(g, d.anim.skewX)),
            "skewY" != f && "skY" != f || (d.anim.skewY = k(g, d.anim.skewY)),
            "x" == f && (d.anim.x = k(g, d.anim.x)),
            "y" == f && (d.anim.y = k(g, d.anim.y)),
            "z" == f && (d.anim.z = k(g, d.anim.z)),
            "transformOrigin" != f && "tO" != f || (d.anim.transformOrigin = g.toString()),
            "transformPerspective" != f && "tP" != f || (d.anim.transformPerspective = parseInt(g, 0)),
            "speed" != f && "s" != f || (d.speed = parseFloat(g)))
        }),
        d
    }
      , n = function(a) {
