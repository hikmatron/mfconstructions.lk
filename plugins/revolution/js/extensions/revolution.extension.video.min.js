    ...
    jQuery.extend(!0, b, {
        ...
        resetVideo: function(a, d) {
            ...
            case "youtube":
                ...
                try {
                    if ("on" == f.forcerewind) {
                        var h = e(a.data("videostartat"))
                          , i = h == -1
                          , j = 1 === f.bgvideo || a.find(".tp-videoposter").length > 0;
                        h = h == -1 ? 0 : h,
                        void 0 != f.player && (0 !== h && !i || j) && (f.player.seekTo(h),
                        f.player.pauseVideo())
                    }
                } catch (a) {}
                0 == a.find(".tp-videoposter").length && 1 !== f.bgvideo && punchgs.TweenLite.to(a.find("iframe"), .3, {
                    autoAlpha: 1,
                    display: "block",
                ...
                break;
            case "vimeo":
                var k = $f(a.find("iframe").attr("id"));
                try {
                    if ("on" == f.forcerewind) {
                        var h = e(f.videostartat)
                          , i = h == -1
                          , j = 1 === f.bgvideo || a.find(".tp-videoposter").length > 0;
                        h = h == -1 ? 0 : h,
                        (0 !== h && !i || j) && (k.api("seekTo", h),
                        k.api("pause"))
                    }
                } catch (a) {}
                0 == a.find(".tp-videoposter").length && 1 !== f.bgvideo && punchgs.TweenLite.to(a.find("iframe"), .3, {
                ...
                break;
            case "html5":
                if (c && 1 == f.disablevideoonmobile)
                    return !1;
                var m = "html5" == f.audio ? "audio" : "video"
                  , n = a.find(m)
                  , o = n[0];
                ...
                "on" == f.forcerewind && !a.hasClass("videoisplaying"))
                    try {
                        var h = e(f.videostartat);
                        o.currentTime = h == -1 ? 0 : h
                    } catch (a) {}
                ("mute" == f.volume || b.lastToggleState(a.videomutetoggledby) || d.globalmute === !0) && (o.muted = !0)
            }
        },
        ...
        manageVideoLayer: function(a, g, i, j) {
            ...
            case "youtube":
                ...
                a.data("videomarkup", '<iframe style="visible:hidden" type="text/html" src="' + v + "://www.youtube.com/embed/" + n + "?" + F + '" ' + G + ' width="100%" height="100%" style="width:100%;height:100%"></iframe>');
                break;
            case "vimeo":
                v = "https",
                a.data("videomarkup", '<iframe style="visible:hidden" src="' + v + "://player.vimeo.com/video/" + o + "?autoplay=0&" + m + '" webkitallowfullscreen mozallowfullscreen allowfullscreen width="100%" height="100%" style="100%;height:100%"></iframe>')
            }
