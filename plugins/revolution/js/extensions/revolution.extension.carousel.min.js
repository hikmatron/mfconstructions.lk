...
!function(a) {
    ...
    jQuery.extend(!0, b, {
        prepareCarousel: function(a, d, h) {
            ...
            void (void 0 == d ? b.carouselToEvalPosition(a, h) : g(a, h, !1)))
        },
    ...
    var d = function(a) {
      ...
      , g = function(a, c, d) {
        ...
        var g = new Object;
        g.from = 0,
        g.to = e.slide_offset_target,
        void 0 !== e.positionanim && e.positionanim.pause(),
        e.positionanim = punchgs.TweenLite.to(g, 1.2, {
            from: g.to,
            onUpdate: function() {
                e.slide_offset = e.slide_globaloffset + g.from,
                e.slide_offset = b.simp(e.slide_offset, e.maxwidth),
                b.organiseCarousel(a, c, !1, !1)
            },
            onComplete: function() {
                e.slide_globaloffset = "off" === e.infinity ? e.slide_globaloffset + e.slide_offset_target : b.simp(e.slide_globaloffset + e.slide_offset_target, e.maxwidth),
                e.slide_offset = b.simp(e.slide_offset, e.maxwidth),
                b.organiseCarousel(a, c, !1, !0);
                var f = jQuery(a.li[e.focused]);
                a.c.find(".next-revslide").removeClass("next-revslide"),
                d && b.callingNewSlide(a.c, f.data("index"))
            },
